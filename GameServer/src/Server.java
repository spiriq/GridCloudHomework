    ...
    public void run()
    {
        ...
        {     
            ...
            if(sentence.startsWith("Hello"))
            {
                ...
                sendToClient(mhandler.IDPacket(clients.size()+1));
                try {
                    BroadCastMessage(mhandler.NewClientPacket(x,y,1,clients.size()+1));
    ...
    public void sendAllClients(DataOutputStream writer)
    {
        ...
        for(int i=0;i<clients.size();i++)
        {
            if(clients.get(i)!=null) {
                ...
                try {
                    writer.writeUTF(mhandler.NewClientPacket(x,y,dir,i+1));
                } catch (IOException ex) {
                    ex.printStackTrace();
                }
            }
